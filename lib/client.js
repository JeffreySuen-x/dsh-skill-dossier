	...
	factory: (require) => {
		...
		*/
		...
		var Panel_module_css_default = {
			...
			"gantt": "JKEyxW_gantt",
			"ganttCell": "JKEyxW_ganttCell",
			"ganttL1": "JKEyxW_ganttL1",
			"ganttL2": "JKEyxW_ganttL2",
			"ganttL3": "JKEyxW_ganttL3",
			"ganttL4": "JKEyxW_ganttL4",
			"ganttLabel": "JKEyxW_ganttLabel",
			"ganttLegend": "JKEyxW_ganttLegend",
			"ganttRow": "JKEyxW_ganttRow",
			"ganttScroll": "JKEyxW_ganttScroll",
			"ganttTick": "JKEyxW_ganttTick",
		...
		*/
		...
		function Panel({ sessionId, prependDraft, themeScheme }) {
			...
			const ganttLevel = (count) => {
				if (count === void 0 || count <= 0) return "";
				if (count === 1) return ` ${Panel_module_css_default.ganttL1}`;
				if (count === 2) return ` ${Panel_module_css_default.ganttL2}`;
				if (count <= 4) return ` ${Panel_module_css_default.ganttL3}`;
				return ` ${Panel_module_css_default.ganttL4}`;
			};
			const reportGantt = (range) => {
				const byDate = new Map(range.days.map((day) => [day.date, new Map(day.projects.map((item) => [item.name, item.count]))]));
				const columnLabel = (date, index) => {
					if (index === 0 || Number(date.slice(8)) % 5 === 0) return String(Number(date.slice(8)));
					return "";
				};
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: Panel_module_css_default.ganttScroll,
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: Panel_module_css_default.gantt,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: Panel_module_css_default.ganttRow,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: Panel_module_css_default.ganttLabel }), range.dates.map((date, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: Panel_module_css_default.ganttTick,
								title: date,
								children: columnLabel(date, index)
							}, date))]
						}), range.projects.map((project) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: Panel_module_css_default.ganttRow,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: Panel_module_css_default.ganttLabel,
								title: project.name,
								children: project.name
							}), range.dates.map((date) => {
								const count = byDate.get(date)?.get(project.name);
								return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: `${Panel_module_css_default.ganttCell}${ganttLevel(count)}`,
									title: `${project.name} · ${date}${count === void 0 ? "（无记录）" : `（${count} 条进展）`}`
								}, date);
							})]
						}, project.name))]
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: Panel_module_css_default.ganttLegend,
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "少" }),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: Panel_module_css_default.ganttCell }),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: `${Panel_module_css_default.ganttCell} ${Panel_module_css_default.ganttL1}` }),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: `${Panel_module_css_default.ganttCell} ${Panel_module_css_default.ganttL2}` }),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: `${Panel_module_css_default.ganttCell} ${Panel_module_css_default.ganttL3}` }),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: `${Panel_module_css_default.ganttCell} ${Panel_module_css_default.ganttL4}` }),
					...
					if (reportView !== "daily" && "dates" in data) {
						...
						content = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									className: Panel_module_css_default.hint,
									children: range.days.length === 0 ? "该区间暂无记录。" : `${range.days.length} 天有记录 · ${active} 个项目 · 亮格＝当天有进展`
								}),
