	...
	factory: (require) => {
		...
		*/
		...
		var Panel_module_css_default = {
			...
			"heatBlank": "JKEyxW_heatBlank",
			"heatCell": "JKEyxW_heatCell",
			"heatGrid": "JKEyxW_heatGrid",
			"heatL1": "JKEyxW_heatL1",
			"heatL2": "JKEyxW_heatL2",
			"heatL3": "JKEyxW_heatL3",
			"heatL4": "JKEyxW_heatL4",
			"heatLegend": "JKEyxW_heatLegend",
			"heatWeek": "JKEyxW_heatWeek",
			"heatWeekdays": "JKEyxW_heatWeekdays",
			"hint": "JKEyxW_hint",
			"input": "JKEyxW_input",
			"list": "JKEyxW_list",
			"muted": "JKEyxW_muted",
			...
			"weekDay": "JKEyxW_weekDay",
			"weekDayLabel": "JKEyxW_weekDayLabel",
			"weekDayNum": "JKEyxW_weekDayNum",
			"weekStrip": "JKEyxW_weekStrip",
			"wrap": "JKEyxW_wrap"
		};
		//#endregion
		...
		*/
		...
		function Panel({ sessionId, prependDraft, themeScheme }) {
			...
			*/
					...
					children: range.dates.map((date) => {
						...
						return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: Panel_module_css_default.weekDayLabel,
									children: WEEKDAY_LABELS[weekday]
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: Panel_module_css_default.weekDayNum,
			...
			const reportMonthCalendar = (range) => {
				const byDate = new Map(range.days.map((day) => [day.date, day]));
				const weeks = [];
				let column = [];
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: Panel_module_css_default.heatGrid,
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: Panel_module_css_default.heatWeekdays,
						children: WEEKDAY_LABELS.map((label, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: index % 2 === 0 ? label : "" }, label))
					}), weeks.map((week, weekIndex) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: Panel_module_css_default.heatWeek,
						children: week.map((date, dayIndex) => date === null ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: Panel_module_css_default.heatBlank }, `empty-${dayIndex}`) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: `${Panel_module_css_default.heatCell}${heatClass(byDate.get(date)?.count ?? 0)}`,
							title: heatTitle(date, byDate.get(date))
						}, date))
					}, weekIndex))]
			...
			const reportHeatLegend = () => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: Panel_module_css_default.heatLegend,
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "少" }),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: Panel_module_css_default.heatCell,
						title: "0 条"
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: `${Panel_module_css_default.heatCell} ${Panel_module_css_default.heatL1}`,
						title: `1~${HEAT_STEPS[0]} 条`
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: `${Panel_module_css_default.heatCell} ${Panel_module_css_default.heatL2}`,
						title: `${HEAT_STEPS[0] + 1}~${HEAT_STEPS[1]} 条`
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: `${Panel_module_css_default.heatCell} ${Panel_module_css_default.heatL3}`,
						title: `${HEAT_STEPS[1] + 1}~${HEAT_STEPS[2]} 条`
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: `${Panel_module_css_default.heatCell} ${Panel_module_css_default.heatL4}`,
						title: `${HEAT_STEPS[2] + 1} 条以上`
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "多" })
				]
			});
			/** 周报/月报的项目卡：作用 / 进度 / 待办 / 难点，一行一项，不展开。 */
			const reportRangeProjects = (projects) => {
					...
					if (reportView !== "daily" && "dates" in data) {
						...
						content = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									className: Panel_module_css_default.hint,
									children: range.days.length === 0 ? "该区间暂无记录。" : `${range.days.length} 天有记录 · ${active} 个项目 · 一格一天，越深＝当天做得越多`
								}),
								range.days.length > 0 ? reportView === "weekly" ? reportWeekStrip(range) : reportMonthCalendar(range) : null,
								reportHeatLegend()
							]
