	...
	factory: (require) => {
		...
		*/
		...
		function Panel({ sessionId, prependDraft, themeScheme }) {
			...
			const [reportRun, setReportRun] = (0, react.useState)(null);
			const [reportHistory, setReportHistory] = (0, react.useState)([]);
			const reload = () => {
				setData(null);
			...
			const loadRuns = () => {
				reportRpc("reviewRuns", { sessionId }).then((res) => {
			...
			const refreshRun = (runId) => {
				reportRpc("reviewStatus", {
					sessionId,
					runId
				}).then((res) => {
					if (res?.ok === true && res.run != null) setReportRun(res.run);
				}).catch(() => void 0);
			};
			const startReview = () => {
				setReportBusy(true);
				...
				reportRpc("review", { sessionId }).then((res) => {
					...
					} else setReportError(res?.error ?? "复盘失败");
				}).catch((error) => {
					setReportBusy(false);
					setReportError(String(error));
				});
			...
			const stopTracking = () => {
				...
				reportRpc("cancelReview", {
					sessionId,
					runId: reportRun.id
				}).then(() => refreshRun(reportRun.id)).catch((error) => setReportError(String(error)));
			};
			const appendToBrief = (project, values) => {
				reportRpc("appendBrief", {
					sessionId,
					date: reportRun?.date,
					project,
					items: { progress: values }
				}).then((res) => setReportNotice(res?.ok === true ? `已追加 ${res.appended ?? 0} 条到 ${res.path}` : res?.error ?? "追加失败")).catch((error) => setReportError(String(error)));
			};
			(0, react.useEffect)(() => {
				if (reportRun?.status !== "running") return;
				const timer = setTimeout(() => refreshRun(reportRun.id), 2e3);
			...
			const reportRunPanel = () => {
				...
				const seconds = Math.round((run.elapsedMs ?? 0) / 1e3);
				const label = run.status === "running" ? `复盘进行中（${seconds}s）` : run.status === "done" ? "复盘完成" : run.status === "cancelled" ? "已停止跟踪" : "复盘失败";
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						run.status === "done" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								"产物：",
								run.artifact === "json" ? run.jsonPath : run.markdownPath,
								run.artifact === "json" ? `（结构化，另有 ${run.markdownPath}）` : ""
							]
						}) : null,
						run.structuredError !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: Panel_module_css_default.hint,
							children: ["结构化产物不合约，已回退 markdown：", run.structuredError]
						}) : null,
						run.error !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: Panel_module_css_default.hint,
							children: run.error
						}) : null,
						run.status === "running" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: Panel_module_css_default.detailActions,
						...
						run.report !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: Panel_module_css_default.hint,
								children: run.report.period
							}),
							[
								["完成", run.report.completed],
								["收获", run.report.learnings],
								["下一步", run.report.next],
								["待解", run.report.openQuestions]
							].map(([title, items]) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: Panel_module_css_default.sectionTitle,
								children: title
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("ul", { children: reportItems([...items], "（无）") })] }, title)),
							run.report.projects.length > 0 && run.report.next.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: Panel_module_css_default.detailActions,
								children: run.report.projects.slice(0, 3).map((project) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
									type: "button",
									className: Panel_module_css_default.reportViewBtn,
			...
			const reportBody = () => {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									className: Panel_module_css_default.reportViewBtn,
									disabled: reportBusy || reportRun?.status === "running",
									onClick: startReview,
									children: "复盘"
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						...
						reportNotice !== "" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						reportRunPanel(),
						reportHistory.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: Panel_module_css_default.reportSec,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								className: Panel_module_css_default.sectionTitle,
								children: [
							...
							}), reportHistory.slice(0, 10).map((entry) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								className: Panel_module_css_default.hint,
								children: [
									entry.date,
									" · ",
									entry.markdown ? "复盘 md" : "",
									entry.json ? `${entry.markdown ? " + " : ""}结构化 json` : ""
								]
							}, entry.date))]
						}) : null,
						content
