		...
		*/
		...
		function normalizeList(res) {
			...
			return {
				...
				scan: r.scan !== null && typeof r.scan === "object" ? r.scan : null,
		...
		function Panel({ sessionId, prependDraft, renderSlot }) {
			...
			const [downloadStatus, setDownloadStatus] = (0, react.useState)("");
			const [downloadDialogOpen, setDownloadDialogOpen] = (0, react.useState)(false);
			const [downloading, setDownloading] = (0, react.useState)(false);
			const menuButton = (0, react.useRef)(null);
			const abortDownload = (0, react.useRef)(null);
			(0, react.useEffect)(() => () => {
				abortDownload.current?.abort();
			}, []);
			const closePanel = () => {
				setOpen(false);
			...
			const heaviest = skills === null ? null : skills.reduce((worst, current) => (current.bodyTokens ?? 0) > (worst?.bodyTokens ?? 0) ? current : worst, null);
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									shadowed === 0 ? null : s.conflictIdentical === false ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
										className: `${Panel_module_css_default.badge} ${Panel_module_css_default.badgeWarn}`,
										title: "同名副本内容存在差异；此处显示当前生效的技能",
										children: ["冲突 ×", shadowed + 1]
									}) : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
										className: Panel_module_css_default.badge,
										title: "同名副本内容一致，只是冗余",
										children: ["副本 ×", shadowed + 1]
									}),
									s.bodyTokens !== null && s.bodyTokens !== void 0 && s.bodyTokens >= 8e3 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
										className: Panel_module_css_default.badge,
										title: "加载一次就要这么多 token",
										children: [
											"重 ",
											Math.round(s.bodyTokens / 1e3),
											"k"
										]
									}) : null
								]
			...
			const costLine = () => {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						" tok（",
						scan.winners,
						" 个技能，仅 name+描述） · 正文加载一次 ≈",
						Math.round(scan.bodyTokens / 1e3),
						"k tok",
						heaviest?.bodyTokens ? `（最大 ${heaviest.name} ≈${Math.round(heaviest.bodyTokens / 1e3)}k）` : "",
						"· 资源包 ",
						mb >= 1 ? `${mb.toFixed(1)} MB` : `${Math.round(scan.assetBytes / 1024)} KB`,
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Menu, {
						...
						onSelect: (id) => {
							setMenuOpen(false);
							if (id === "manage") setOpen(true);
							else download();
						},
						anchor: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							ref: menuButton,
							type: "button",
							className: Panel_module_css_default.toggle,
							"aria-label": "更多操作",
							"aria-haspopup": "menu",
					...
					open ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: `${Panel_module_css_default.panel}${tab === "usage" ? ` ${Panel_module_css_default.usagePanel}` : ""}`,
						onKeyDown,
						role: "dialog",
						"aria-label": "管理",
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: "管理" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
							...
							tab !== "usage" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								className: Panel_module_css_default.header,
							...
							tab !== "usage" && usageHealth !== null ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								className: Panel_module_css_default.notice,
								children: ["调用统计写盘失败（技能本身不受影响）：", usageHealth]
							}) : null,
							tab !== "usage" && scanError !== null ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								className: Panel_module_css_default.notice,
								children: ["技能根扫描失败，本页只看注册表（被遮蔽的同名副本看不到）：", scanError]
							}) : null,
							tab === "usage" ? renderSlot("skill-manager.usage", {}, { fallback: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: "用量插件未加载，请启用 dsh-token-dashboard 后重新打开。" }) }) : tab === "archive" ? archiveBody() : tab === "report" ? reportBody() : view === "list" ? listBody() : detailBody()
						]
					}) : null
				]
			});
